...
1. Now in the **SQL managed instance - Azure Arc Data Controller dashboard**, copy the **IP Address** under external endpoint. You can also see that the status is **Ready**.
...
1. Open Azure Data studio on JumpVM and right-click on the SQL MI resource under the Azure Arc controller and click on manage.
